...
import heroImage from "@/assets/section1.webp";
      ...
      <div className="section-container">
        ...
        >
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6 max-w-xl mx-auto">
            ...
            <span className="tag-badge">AI Agent</span>
            <span className="tag-badge">Web development</span>
            <span className="tag-badge">2025</span>
          </div>
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight mb-6">
            Profit plus landing page
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            This website was created for a crypto signals Telegram group.
          </p>
        </motion.div>
